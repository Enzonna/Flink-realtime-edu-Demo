...
DwdTrafficUserJumpDetail {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> pageLog = env.fromSource(kafkaConsumer,
                WatermarkStrategy.noWatermarks(), "user_jump_source");
        ...
        KafkaSink<String> kafkaProducer = KafkaUtil.getKafkaProducer(targetTopic, "user_jump_trans");
        unionDStream.map(JSONAware::toJSONString).sinkTo(kafkaProducer);
