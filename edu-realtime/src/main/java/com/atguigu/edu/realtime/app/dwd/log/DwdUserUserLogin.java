...
public class DwdUserUserLogin {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> source = env.fromSource(kafkaConsumer,
                WatermarkStrategy.noWatermarks(), "user_login_source");
        ...
        // TODO 7. 运用 Flink 状态编程和定时器保留各会话的登录日志
        ...
        KafkaSink<String> kafkaProducer = KafkaUtil.getKafkaProducer(sinkTopic, "user_login_trans");
        finalStream.sinkTo(kafkaProducer);
