...
public class DwsTrafficVcSourceArIsNewPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> source = env.fromSource(kafkaConsumer,
                WatermarkStrategy.noWatermarks(), "dws_pv_page_log_source");
        ...
        KafkaSource<String> uvKafkaConsumer = KafkaUtil.getKafkaConsumer(uvTopic, uvGroupId);
        DataStreamSource<String> uvSource = env.fromSource(uvKafkaConsumer,
                WatermarkStrategy.noWatermarks(), "dws_pv_unique_visitor_source");
        ...
        KafkaSource<String> ujdKafkaConsumer = KafkaUtil.getKafkaConsumer(ujdTopic, ujdGroupId);
        DataStreamSource<String> ujdSource = env.fromSource(ujdKafkaConsumer,
                WatermarkStrategy.noWatermarks(), "dws_pv_user_jump_source");
